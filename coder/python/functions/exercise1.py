'''
	...
	- - - - - - - - - - - - - - - - - - - - - - - - - - - - 
		...
		1. Normal Function : This type of function is simple and returns at 1 level, it doesn't have nesting.
		...
		1. Nested Function : This type of function is complex and returns after multiple calls.
