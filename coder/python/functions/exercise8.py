...
def func_huge_tests(ranges):
    ...
    while True:
        ...
        memoryUse = memory_info[0]
        print("\n\n *** LIVE *** \n\n")
        print('GB Memory Used by Python ::', memoryUse/ (1000 ** 3))
        print("\n Describe Python Process... {}".format(psutil.Process(pid)))
