...
class Person:
    ...
    def __new__(cls,*args):
        ...
        '''
            ...
            In this case we would get error as follows while creating an instance of the class.

            * The instance will not get created *
            ...
            # Since the instance is not created we cant execute any method inside the class.
        ...
        # Use the built-in object to create the instance.
        instance = object.__new__(cls)
        # Prevent the User from creating any instance-raise an exception.
        raise Exception("Instance Creation not Permitted. Class is Secured.")
...
if __name__ == "__main__":
    ...
    # Since the instance is not created in __new__ method, the below method will not get executed
    # This line - instance_person.about() will not get executed.
    instance_person.about()
