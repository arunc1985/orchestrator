'''
    ...
    ** Refer to README file for detailed documentation on the Classes.
    ...
    -----------------------
        ...
        In this example , we will a special magic method __next__ for creating an iterable.
        When we define __next__ method in the class we can customize the iterator.
...
class Generator:
    ...
    def __next__(self):
        '''
            Generates the next value in the iterable.
            Example :
                # Create an instance of the Generator Class
                instance_gen = Generator(10)        
                print(instance_gen.__next__())
            ...
            The following __next__ method calculate the power of all number in the range.
